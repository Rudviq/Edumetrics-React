    ...
    <div>
      ...
      <div className="dropdown">
        ...
        <div className="dropdown-content">
          <a href="/home"><img src="icons/icons8-home-50.png" />Home</a>
          <a href="/services"><img src="icons/icons8-services-50.png" />Services</a>
          <a href="/contact_us"><img src="icons/icons8-contact-us-50.png" />Contact Us</a>
          <a href="/aboutus"><img src="icons/icons8-about-us-50.png" />About Us</a>
          <a href="https://bxd3672.uta.cloud/wordpress_blog/">
            <img src="icons/blog.png" />
            Our Blog
          </a>
          <a href="/login"><img src="icons/exit.png" />Log Out</a>
        </div>
      </div>
      </div>
      <div className="container">
        ...
        <div className="questions">
          <div className="question">
            <p>By: Adam Loius (Student) - Fall 2023</p>
            <p>Question : What is the procedure to take an additional course for the summer semester?</p>
            <button className="answer-btn" onClick={() => toggleAnswerArea(0)}>Answer</button>
            <div className={`answer-area ${answers[0] ? 'open' : ''}`}>
              <textarea placeholder="Your answer..."></textarea>
              <button className="send-btn">Send</button>
            </div>
          </div>
          <div className="question">
            <p>By: Emma Watson (Professor)</p>
            <p>Question: How can instructors access student records and rosters?</p>
            <button className="answer-btn" onClick={() => toggleAnswerArea(1)}>Answer</button>
            <div className={`answer-area ${answers[1] ? 'open' : ''}`}>
              <textarea placeholder="Your answer..."></textarea>
              <button className="send-btn">Send</button>
            </div>
          </div>
          <div className="question">
            <p>By: Albus Dumbledore (Adjunct Professor)</p>
            <p>Question: What support is available for course development and teaching resources?</p>
            <button className="answer-btn" onClick={() => toggleAnswerArea(2)}>Answer</button>
            <div className={`answer-area ${answers[2] ? 'open' : ''}`}>
              <textarea placeholder="Your answer..."></textarea>
              <button className="send-btn">Send</button>
            </div>
          </div>
      ...
      <a href="javascript:void(0)" class="closebtn" id="closeChatButton">&times;</a>
        <div class="chat">
            <div class="chat-message bot">Hello! How can I assist you today?</div>
            <div class="chat-message user">Hi! I have a question.</div>
           
        </div>
        <div class="user-input">
            <input type="text" id="userMessage" placeholder="Type your message..."></input>
      ...
      <div></div>
        <img src="images/uta_logo.png" alt="UTA" class="uta_logo"></img>
        <div class="uni_info">
        ...
        <div class="contact-us">
            <img src="images/footer/facebook-app-symbol.png" alt="facebook"></img>
            <img src="images/footer/email.png" alt="mail"></img>
            <img src="images/footer/linkedin.png" alt="linkedin"></img>
            <img src="images/footer/twitter (1).png" alt="twitter"></img>
