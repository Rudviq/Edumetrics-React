  ...
  return (
    ...
    <div className="topnav">
      ...
      <div className="dropdown">
        ...
        <div className="dropdown-content">
          ...
          <a href="#">
            <img src="icons/scholarship.png" alt="Scholarship" />
            Charges Due
          </a>
    ...
    <div className="container">
      <div className="upcoming">
        ...
        <button id="expandScheduleButton">Show Full Schedule</button>
      ...
      <div className="upcoming-schedule" style={{ display: 'none' }}>
        {/* Add the schedule items for the first 7 days here */}
        {/* For demonstration purposes, I'm using placeholders */}
        <div className="upcoming-item">
          {/* Day 1 Schedule */}
        </div>
        <div className="upcoming-item">
        ...
        {/* Add more items for days 3 to 7 here */}
      </div>
      ...
      <div className="courses">
        <div>
          <h5>CSE-5305-003</h5>
          <h6>Software Engineering & Techniques</h6>
          {/* <h6>Hi</h6> */}
        ...
        <div>
          <h5>CSE-5305-003</h5>
          <h6>Advance Database Systems</h6>
          {/* <h6>Hi</h6> */}
          <div className="buttons">
            <button>Assessment</button>
            <button>Analytics</button>
