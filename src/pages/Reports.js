...
function StudentReport({ name, grade, attendance, assignments, exams, feedback, graphImage }) {
  return (
...
function MainContent() {
  // Define data for student reports
  const studentReports = [
    {
      name: 'Student 1',
      grade: 'A',
      attendance: '95%',
      assignments: ['Assignment 1: 95%', 'Assignment 2: 88%', 'Assignment 3: 92%'],
      exams: ['Midterm Exam: 90%', 'Final Exam: 88%'],
      feedback: 'Student 1 feedback',
      graphImage: 'images/course_1.jpg',
    },
    {
      name: 'Student 2',
      grade: 'A',
      ...
      assignments: ['Assignment 1: 95%', 'Assignment 2: 88%', 'Assignment 3: 92%'],
      exams: ['Midterm Exam: 90%', 'Final Exam: 88%'],
      feedback: 'Student 2 feedback',
      graphImage: 'images/course_2.jpg',
    },
    {
      name: 'Student 3',
      grade: 'A',
      ...
      assignments: ['Assignment 1: 95%', 'Assignment 2: 88%', 'Assignment 3: 92%'],
      exams: ['Midterm Exam: 90%', 'Final Exam: 88%'],
      feedback: 'Student 3 feedback',
      graphImage: 'images/course_3.jpg',
    },
  ];
  ...
  return (
    <main>
      <div className="contact-list">
        {studentReports.map((studentReport, index) => (
          <StudentReport key={index} {...studentReport} />
        ))}
      </div>
    </main>
  );
